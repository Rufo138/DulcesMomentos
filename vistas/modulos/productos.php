                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle backColor" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu backColor" role="menu">
                            <?php
                            echo '<li><a href="'.$url.$rutas[0].'/1/reciente">Más Reciente</a></li>
                                 <li><a href="'.$url.$rutas[0].'/1/antiguo">Más Antiguo</a></li>';
                            ?>
                        </ul>
        ...
        if(count($listaProductos) != 0){
            ...
            if($pagProductos > 4){
               ...
               ';
                ...
                for($i = 1; $i <= 4; $i ++){
                    echo '<li id="item'.$i.'" class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/'.$i.'">'.$i.'</a></li>';

                }
                echo '<li class="disabled"><a class="page-link">...</a></li>
                      <li id="item'.$pagProductos.'" class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/'.$pagProductos.'">'.$pagProductos.'</a></li>
                ...
                /*=============================================
                    ...
                    elseif($rutas[1] == $pagProductos){
                        echo '<ul class="pagination" style="margin:20px 0">
                        <li class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/'.($pagProductos-1).'"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
                        <li class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/1">1</a></li>
               ...
               ';
                        ...
                        echo '<li class="disabled"><a class="page-link">...</a></li>
                            <li class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/'.$pagProductos.'">'.$pagProductos.'</a></li>
            ...
            echo'<li id="item'.$i.'" class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/'.($numPagActual+1).'"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>';
